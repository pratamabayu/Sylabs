...
{
    public class ClipStatementExpression : Symbol
    {
        public ClipStatementExpression(params Object[] symbols) : base(symbols) { }

        public static ClipStatementExpression Produce(IEnumerable<Symbol> symbols)
        {
            ...
            return result == null ? null : new ClipStatementExpression(result);
        }        
    }
}
