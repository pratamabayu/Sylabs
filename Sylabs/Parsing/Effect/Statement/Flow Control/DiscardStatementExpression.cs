...
{
    public class DiscardStatementExpression : Symbol
    {
        public DiscardStatementExpression(params Object[] symbols) : base(symbols) { }

        public static DiscardStatementExpression Produce(IEnumerable<Symbol> symbols)
        {
            ...
            return symbols == null ? null : new DiscardStatementExpression(result);
        }        
    }
}
