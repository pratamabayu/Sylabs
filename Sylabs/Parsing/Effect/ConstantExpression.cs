...
{
    public class ConstantExpression : Symbol
    {
        #region Fields
        ...
        public ConstantExpression(params Object[] inputSymbols) : base(inputSymbols) 
        {
            // Get data
        ...
        public static ConstantExpression Produce(IEnumerable<Symbol> symbols)
        {
            return symbols == null ? null : new ConstantExpression(symbols);
        }
    }
}
